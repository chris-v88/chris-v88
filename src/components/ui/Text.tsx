...
export const Text = ({ display, children, className = '' }: TextProps) => {
  ...
  switch (display) {
    case 'h1':
      return <h1 className={cx('font-press-start-2p text-xl font-normal')}>{children}</h1>;
    case 'h2':
      return <h2 className={cx('font-press-start-2p text-lg font-bold')}>{children}</h2>;
    case 'h3':
      return <h3 className={cx('font-press-start-2p text-sm font-bold')}>{children}</h3>;
    case 'h4':
      return <h4 className={cx('font-press-start-2p text-xs font-bold')}>{children}</h4>;
    case 'body':
